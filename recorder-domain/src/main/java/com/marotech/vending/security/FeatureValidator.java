package com.marotech.vending.security;

import com.marotech.vending.model.Feature;
...
public class FeatureValidator extends DefaultHandler {
    ...
    public void parse() {
        ...
        try {
            ...
            log
                    .error("ParserConfigurationException - Error parsing document : " + fileName, e);
            ...
            System.out.println("SAXException - Error parsing document : " + fileName + " : " + e.getMessage());
            System.exit(0);
        } catch (IOException e) {
    ...
    private void validateFeatures() {
        for (Feature feature : features.values()) {
            Feature f = repositoryService.fetchFeatureByName(feature.getName());
            if (f == null) {
