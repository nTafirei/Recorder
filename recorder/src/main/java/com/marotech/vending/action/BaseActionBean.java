...
import com.marotech.vending.security.SecurityAwareActionBean;
import com.marotech.vending.service.HazelcastService;
import com.marotech.vending.util.Constants;
import com.marotech.vending.util.VendActionBeanContext;
...
public abstract class BaseActionBean extends SecurityAwareActionBean implements
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.marotech.vending.action.BaseActionBean.class);
