...
<s:layout-render name="/WEB-INF/jsp/layout.jsp" title="Top Up Float">
            ...
            <div class="container">
                <div id="content">
                    ...
                    <security:protected-element name="give-agent-float">
                       ...
                       <s:form action="/web/top-up-float" name="createForm" id="createForm" method="post">
                         ...
                         <table width="100%">
                             <tr>
                                 <td align="center" colspan="3">
                                     <fmt:message key="topupfloatlabel"/> for ${actionBean.agentFloat.agent.fullName},
