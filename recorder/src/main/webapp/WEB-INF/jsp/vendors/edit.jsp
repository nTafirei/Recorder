...
<s:layout-render name="/WEB-INF/jsp/layout.jsp" title="Edit Vendor">
            ...
            <div class="container">
                <div id="content">
                    ...
                    <security:protected-element name="manage-vendors">
                       <s:form action="/web/edit-vendor" name="createForm" id="createForm" method="post">
                        <input type="hidden" name="_eventName" id="_eventName" value="save"/>
                        <input type="hidden" name="vendor" id="vendor" value="${actionBean.vendor.id}"/>
                         <table width="100%">
                             <tr>
                                 <td align="center" colspan="3">
                                     <fmt:message key="editvendorlabel"/>
                                 </td>
                             </tr>
                         </table>
