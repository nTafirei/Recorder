...
<s:layout-render name="/WEB-INF/jsp/layout.jsp" title="Edit Product">
            ...
            <div class="container">
                <div id="content">
                    ...
                    <security:protected-element name="manage-products">
                       <s:form action="/web/edit-product" name="createForm" id="createForm" method="post">
                         <input type="hidden" name="_eventName" id="_eventName" value="save"/>
                         <input type="hidden" name="product" id="product" value="${actionBean.product.id}"/>

                        <table width="100%">
                            <tr>
                                <td align="center" colspan="3">
                                    <fmt:message key="editproductlabel"/> for ${actionBean.product.merchant.name}
                                </td>
                            </tr>
                        </table>
                        <table class="alternating">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <d:text style="background-color:#F0E68C" name="availabilityDate"
                                        value="${actionBean.availabilityDate}" id="availabilityDate" class="availabilityDate"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <d:text style="background-color:#F0E68C" id="expiryDate" name="expiryDate" value="${actionBean.expiryDate}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
