                ...
                <div class="row 200%">
                    <div class="8u important(collapse)">
                        <div id="content">
                            ...
                            <!-- Content -->
                            <article>
                                <s:form action="/web/deposit" method="post" name="depositForm" id="depositForm">
                                <input type="hidden" name="target" value="${actionBean.target}"/>
                                <input type="hidden" name="_eventName" value="deposit"/>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <th colspan="2">
                                            <h4><fmt:message key="depositlabel"/>: ${actionBean.user.fullName},
                                    ...
                                    <tr valign="top">
                                        <td nowrap="nowrap">
                                            ...
                                            id="amount" placeholder="Amount to deposit"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
