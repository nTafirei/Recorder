...
<s:layout-render name="/WEB-INF/jsp/layout.jsp" title="Forgot Password">
                    ...
                    <div class="8u important(collapse)">
                        <div id="content">
                            ...
                            <article>
                                ...
                                <input type="hidden" name="_eventName" value="answerQuestions"/>
                                ...
                                <table>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td nowrap="nowrap">
                                            ...
                                            <d:text style="background-color:#F0E68C" name="mobileNumber" id="mobileNumber"/>
                                        </td>
