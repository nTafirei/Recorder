...
<s:layout-render name="/WEB-INF/jsp/layout.jsp" title="Top Up Vendor Account">
                ...
                <div class="row 200%">
                    <div class="8u important(collapse)">
                        <div id="content">
                            ...
                            <!-- Content -->
                            <security:protected-element name="top-up-vendors">
                            <article>
                                <s:form action="/web/top-up-vendor" method="post" name="searchForm" id="searchForm">
                                <input type="hidden" name="target" value="${actionBean.target}"/>
                                <input type="hidden" name="_eventName" value="save"/>
                                <input type="hidden" name="vendor" value="${actionBean.vendor.id}"/>

                                <table>
                                    <thead>
                                    <tr>
                                        <th colspan="2">
                                            <h4><fmt:message key="topupvendoraccountlabel"/> for ${actionBean.vendor.name}.
