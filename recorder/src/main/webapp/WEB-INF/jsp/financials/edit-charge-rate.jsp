            ...
            <div class="container">
                <div id="content">
                    ...
                    <security:protected-element name="manage-charge-rates">
                       <s:form action="/web/edit-charge-rate" name="createForm" id="createForm" method="post">
                        <input type="hidden" name="_eventName" id="_eventName" value="save"/>
                        <input type="hidden" name="chargeRate" id="chargeRate" value="${actionBean.chargeRate.id}"/>
                        <table class="alternating">
                                <tbody>
                                <tr>
                                    <td colspan="2">
                                        ${actionBean.chargeRate.name} charge rates for ${actionBean.formattedDay} in ${actionBean.purchaseCurrency}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
