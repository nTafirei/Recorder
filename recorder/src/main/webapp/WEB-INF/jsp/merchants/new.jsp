...
<s:layout-render name="/WEB-INF/jsp/layout.jsp" title="Add New Merchant">
            ...
            <div class="container">
                <div id="content">
                    ...
                    <security:protected-element name="manage-merchants">
                       <s:form action="/web/new-merchant" name="createForm" id="createForm" method="post">
                         <input type="hidden" name="_eventName" id="_eventName" value="save"/>

                        <table width="100%">
                            <tr>
                                <td align="center" colspan="3">
                                    <fmt:message key="addnewmerchantlabel"/>
                                </td>
                            </tr>
                        </table>
